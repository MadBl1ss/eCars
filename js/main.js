...
function activeFeatured() {
  linkFeatured.forEach((elem) => elem.classList.remove("active-featured"));
  this.classList.add("active-featured");
}
linkFeatured.forEach((elem) => elem.addEventListener("click", activeFeatured));
...
this.addEventListener("scroll", scrollActive);
